...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  planningCalibration: 'planning.md',
  planningReview: 'planning.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  PlanningView: 'planning.md',
  PlanningProposalSnapshot: 'planning.md',
  StageProposalRequest: 'planning.md',
  DecideProposalRequest: 'planning.md',
  CreatePortfolioRequest: 'planning.md',
  PortfolioSnapshot: 'planning.md',
  FeatureAttemptSnapshot: 'planning.md',
  StartAttemptRequest: 'planning.md',
  FinishAttemptRequest: 'planning.md',
  ExecutionSliceSnapshot: 'planning.md',
  StartSliceRequest: 'planning.md',
  FinishSliceRequest: 'planning.md',
  PlanningObservation: 'planning.md',
  CalibrationSample: 'planning.md',
  CalibratedEstimate: 'planning.md',
  CalibrationEstimateRequest: 'planning.md',
  ScheduleCandidate: 'planning.md',
  ScheduleRecommendation: 'planning.md',
  PlanningSourceAdapter: 'planning.md',
  PlanningReviewResult: 'planning.md',
  PlanningApproval: 'planning.md',
