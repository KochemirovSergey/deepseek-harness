...
const PEER_REQUIRED_HOST_EXPORTS = {
  '@deepseek-ai/dsh-launch-environment': ['instanceHttpAllowed', 'authorizeInstanceRemote', 'instancePolicy', 'InstancePolicyDenied', 'instanceModelConfig', 'launchEnvironmentOf'],
