...
describe('gen-tool-catalog collectToolCatalog', () => {
  it('boots every shipped tool package and harvests its model-facing schemas', async () => {
    ...
    expect(names).toEqual([
      ...
      'list_agents', 'list_agents', 'lsp', 'planning_apply_proposal', 'planning_create_portfolio',
      'planning_finish_attempt', 'planning_finish_slice', 'planning_review_proposal',
      'planning_start_attempt', 'planning_start_slice', 'planning_status', 'pwsh', 'pwsh', 'ralph',
