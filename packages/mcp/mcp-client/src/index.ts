...
export interface StdioConfig {
  ...
  /** Use legacy initialize directly for gateways that reject discovery probes. Defaults to auto. */
  protocolNegotiation?: 'auto' | 'legacy'
...
export const Config = z.union([
  z.object({
    ...
    protocolNegotiation: z.union([z.const('auto'), z.const('legacy')]).default('auto'),
    reconnect: Reconnect,
  }),
  z.object({
