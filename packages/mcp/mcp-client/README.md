...
| `protocolNegotiation` | `auto` | Set `legacy` for a gateway that rejects `server/discover`; connects directly with `initialize`, retaining authentication and tool restrictions |
