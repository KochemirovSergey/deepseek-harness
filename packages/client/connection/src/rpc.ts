...
export interface HostConnectionRpc {
  /**
   * Register one authenticated absolute channel prefix on an active Web server.
   * Throws when no Web server is available; the route belongs to the caller plugin.
