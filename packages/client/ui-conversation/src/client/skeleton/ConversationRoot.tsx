...
export function ConversationRoot({
  ...
  renderSlot, renderSlotChain, selectWorkspace, t, restricted = false,
  ...
  const heroWorkspaceRow = restricted ? null : (
  ...
  const inert = sessionId === undefined || (!restricted && hero && chipTitle === undefined)
